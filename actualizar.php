...
<body data-offset="40" background="images/wp2264184.png" style="background-attachment: fixed">
<div class="container">
<header class="header">
<div class="row">
	<?php
...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
	...
	//la variable  $mysqli viene de connect_db que lo traigo con el require("connect_db.php");
		...
		<form action="ejecutaactualizar.php" method="post">
				...
				Edad<br> <input type="text" name="edad" value="<?php echo $edad?>"
				><br>
				...
				Numero<br> <input type="text" name="numero" value="<?php echo $numero?>">
				<br>
				<input type="submit" value="Guardar" class="btn btn-success btn-primary">
				<a class="btn btn-warning" href="./admin.php">Cancelar</a>
			</form>
...
<hr class="soften"/>
<p>&copy; Copyright Luis Armando Ortiz Salinas <br/><br/></p>
 </footer>
</div><!-- /container -->
