...
class Backup_Database {
    ...
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8') {
        ...
        $this->backupFile              = 'myphp-backup-'.$this->dbName.'-'.date("Ymd_gis", time()).'.sql';
...
echo '<script>alert("Base de datos respaldada")</script> ';
echo "<script>location.href='../backupAndRestore/BackupAndRestore.php'</script>";
